...
namespace Sleet {
	...
	ImguiSystem::ImguiSystem(Window& window, VulkanDevice& device, VkRenderPass renderPass, uint32_t imageCount):
		device(device)
	{
		...
		{
			SL_ERROR("Failed to set up descriptor pool for imgui");
		}
